...
public class CheckInOrderedArrayTest {
    ...
    public void checkElementNotInOneElementArray(){
       Assertions.assertFalse(checker.checkElementInArrayIteratively(2, new int[]{1}));
    }
    ...
    public void checkElementInOneElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(2, new int[]{2}));
    }
    ...
    public void checkBiggerElementNotInTwoElementArray(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(4, new int[]{1, 3}));
    }
    ...
    public void checkSmallerElementNotInTwoElementArray(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(1, new int[]{2, 3}));
    }
    ...
    public void checkElementBetweenTwoArrayElements(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(2, new int[]{1, 3}));
    }
    ...
    public void checkBiggerElementInTwoElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(3, new int[]{1, 3}));
    }
    ...
    public void checkSmallerElementInTwoElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(2, new int[]{2, 3}));
    }
    ...
    public void checkBiggerElementNotInThreeElementArray(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(5, new int[]{1, 3, 4}));
    }
    ...
    public void checkSmallerElementNotInThreeElementArray(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(1, new int[]{2, 3, 4}));
    }
    ...
    public void checkElementBetweenThreeArrayElements(){
        Assertions.assertFalse(checker.checkElementInArrayIteratively(2, new int[]{1, 3, 4}));
    }
    ...
    public void checkBiggerElementInThreeElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(4, new int[]{1, 3, 4}));
    }
    ...
    public void checkSmallerElementInThreeElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(2, new int[]{2, 3, 4}));
    }
    ...
    public void checkElementInTheMiddleThreeArrayElements(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(3, new int[]{1, 3, 4}));
    }
    ...
    public void checkBiggerElementInFourElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(4, new int[]{1, 3, 4, 6}));
    }
    ...
    public void checkSmallerElementInFourElementArray(){
        Assertions.assertTrue(checker.checkElementInArrayIteratively(3, new int[]{2, 3, 4, 6}));
    }
