...
class Access {
    ...
    //inner class can be with any access
    protected class InnerParent{
        ...
        {
            System.out.println("inner parent, non-static init block. Inner class as a member of outer class, has access without any instance to all content of outer class including private");
            System.out.println("privateS=" + privateS);
        }
    ...
    //nested class can be with any access
    public static class StaticInnerParent{
        static{
            System.out.println("Inner static parent, static block, has access to static private content of outer class without any instance, privateStatic:"+ privateStatic);
        }

        {
            System.out.println("inner static parent, non-static init block. Even if it's nonstatic block, class is static, so it's static member of outer class and doesn't have access to nonstatic content of outer class");
        }
    ...
    static {
        System.out.println("Main class, static block. Has access to private static inner vars, StaticInnerParent.staticInnerParentPrivateStatic="+StaticInnerParent.staticInnerParentPrivateStatic);
        System.out.println("Main class, static block. Has access to private static inner meth, StaticInnerParent.staticInnerParentPrivateStaticMethod():");
        StaticInnerParent.staticInnerParentPrivateStaticMethod();
    }

    {
        System.out.println("Main class, nonstatic block. Has access to private vars and meth of inner class: new InnerParent().innerParentPrivateS="+ new InnerParent().innerParentPrivateS);
        new InnerParent().innerParentPrivateMethod();
        new StaticInnerParent().staticInnerParentPrivateMethod();
    ...
    Access(){
        ...
        System.out.println(" Main class, constructor. can see private vars and methods from any inner class throw their instances new InnerChild().innerChildPrivateMethod():");
        new InnerChild().innerChildPrivateMethod();
        new StaticInnerParent().staticInnerParentPrivateMethod();
        StaticInnerParent.staticInnerParentPrivateStaticMethod();
    }
    ...
    public static void main(String[] args) {
        StaticInnerParent s = new StaticInnerParent();
        Access a = new Access();
        System.out.println("main method(and any other nonstatic method), can run private vars and method from static inner class, throw their instance new StaticInnerParent().staticInnerParentPrivateMethod();");
        new StaticInnerParent().staticInnerParentPrivateMethod();
        StaticInnerParent.staticInnerParentPrivateStaticMethod();
        System.out.println(" main method(and any other static), can see private vars and methods from nonstatic inner class throw main class instance: a.new InnerChild().innerChildPrivateMethod():");
        a.new InnerChild().innerChildPrivateMethod();
